...
/***/ function(module, exports, __webpack_require__) {
	...
	Page({
        ...
        var c = wx.getStorageSync('location_place');
	        var cityArr = ['上海', '北京'];
	        this.setData({
	            cityArr: cityArr,
	            city: c
      ...
      wxSortPickerViewItemTap: function wxSortPickerViewItemTap(e) {
	    ...
	    cxgps: function() {
        wx.setStorageSync('location_place', this.data.city);
        wx.switchTab({
          url: '../index/index',
        })
	    },
